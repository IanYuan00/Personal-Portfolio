            ...
            <Container>
                <Row className="align-item-left">
                    ...
                    <div className="social-icon">
                        <a href="https://github.com/IanYuan00" target="_blank"><img src={githubLogo} /></a>
                        <a href="https://www.linkedin.com/in/yuan-gao-yg0522" target="_blank"><img src={linkedinLogo} /></a>
                        <a href="mailto:yuangao2517@gmail.com"><img src={emialIcon} /></a>
                    </div>
